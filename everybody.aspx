<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="everybody.aspx.cs" Inherits="UI.everybody" %>
...
<head>
    ...
    <link rel="stylesheet" href="css/everybody.css">
...
<body>
    ...
    <div id="body">
        <div class="user">
            ...
            <input id="id" type="hidden" value="<%= per.id %>" />
            <img src="<%= per.face %>" title="<%= per.nickname %>" />
            <h2><%= per.nickname %></h2>
            ...
            <footer style="margin-bottom:10px;"><%= per.myself %></footer>
            <button id="guanzhu-button" style="width:120px;"  type="button" class="btn btn-success">
               <span style="color:#ffffff;font-size:12px" class="glyphicon  glyphicon-plus "></span>
               关注</button>
            <button id="fa" style="width:120px;margin-left:10px;" type="button" class="btn btn-primary">
                
                <span style="color:#ffffff; font-size:12px" class="glyphicon glyphicon-envelope"></span>
                发私信</button>
        </div>
        ...
        <div class="right">
            ...
            <div class="top-select">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="搜索微博">
                    <span class="input-group-btn">
                        <button class="btn btn-default" type="button">
                            <i class="glyphicon glyphicon-search"></i>
                        </button>
  ...
  <ul style="font-size:20px;padding-top:5px" class="pager">
    <li  class="previous">
        ...
        <a href="everybody.aspx?page=<%= pre %>&personid=<%= per.id %>">
            <span aria-hidden="true">&larr;</span>上一页

        </a></li>
    <li class="nextt" style="float:right"><a href="everybody.aspx?page=<%= next %>&personid=<%= per.id %>">下一页 <span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
            </div>
    ...
    <script type="text/javascript" src="js/everybody.js"></script>
</body>
</html>