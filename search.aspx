  ...
  <div id="body">
      <div class="search-bar">
          ...
          <div class="btn-group" data-toggle="buttons">
              <label id="select-weibo" style="width:100px"  class="btn btn-primary active">
                  <input   type="radio"  name="options" value="1" >找微博
              </label>
              <label style="width:100px" class="btn btn-primary">
      ...
      <div class="left">
          ...
          <div class="weibo">
              <h2>
                  <a title="<%= user.nickname %>" href="everybody.aspx?personid=<%= user.id  %>">
                     <%= user.nickname %>

                  </a>
                   <% for (int i = 0; i < DateTime.Now.Year-user.time.Year+1; i++)
                           {
                             %>
              ...
              <div class="face">
                  <a href="everybody.aspx?personid=<%= user.id %>">
                      <img style="height:50px;width:50px;" class="img-circle" src="<%= user.face %>" />
                  </a>
              </div>
          ...
          <div class="page">
             <nav>
  <ul style="background-color:white;width:600px;height:40px;padding-top:5px;padding-left:10px;padding-right:10px;" class="pager">
    <li style="margin-right:340px;" ><a href="search.aspx?words=<%= Request["words"] %>&page=<%= pre %>"><span aria-hidden="true">&larr;</span>上一页</a></li>
    <li> <a href="search.aspx?words=<%= Request["words"] %>&page=<%= next %>">下一页<span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
          </div>
      </div>
