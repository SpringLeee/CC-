<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="person.aspx.cs" Inherits="UI.person" %>
...
<body onload="init()">
    <div id="bg">
        ...
        <div class="content">
            <h2>仅需四步，完善资料，您可以找到您的同学和同事了！</h2>

            <div class="biaodan">
                <div id="nickname-info" class="info">
                    <span style="color:#ff6a00" class="glyphicon glyphicon-info-sign"></span>
                    <label>未完成</label>
                </div>
                ...
                <div id="nickname-warring" class="warring">
                    <span class="glyphicon glyphicon-info-sign"></span>
                    <label>4-10位，不能带标点符号</label>
                </div>
            </div>
            <div class="biaodan">
                <div id="date-info" class="info">
                    <span style="color:#ff6a00" class="glyphicon  glyphicon-info-sign"></span>
                    <label>未完成</label>
                </div>
                ...
                <div id="date-warring" class="warring">
                    <span class="glyphicon glyphicon-info-sign"></span>
                    <label>请选择生日</label>
                </div>
            </div>
            ...
            <div class="radio">
                ...
                <div class="shuru">
                    <label style="font-weight:bold;margin:0 0 0 18px">性别：</label>
                     
                    <div class="sex">
                        <label class="radio-inline">
                            <input  type="radio" name="inlineRadioOptions" checked="checked" value="男"> 男
                        </label>
                        <label class="radio-inline">
                            <input id="sex" type="radio" name="inlineRadioOptions"  value="女"> 女
                        </label>
                    </div>
            ...
            <div class="radio">
                <div id="city-info" class="info">
                    <span style="color:#ff6a00" class="glyphicon glyphicon-info-sign"></span>
                    <label>未完成</label>
                </div>

                <div class="shuru">
                    <label style="font-weight:bold;margin:0 0 0 18px">所在地：</label>

                    <div class="sex">
                        <form action="<#ZC_BLOG_HOST#>" method="post" name="creator" enctype="multipart/form-data">
                            <select class="form-control"  id="province" name="province" onChange="select()"></select>

                            <select class="form-control" id="city" name="city"  onChange="select()"></select>
                        </form>


                        <div id="city-warring" class="warring">
                            <span style="display:none;" class="glyphicon glyphicon-info-sign"></span>
                            <label style="display:none">请正确的选择地址</label>
                        </div>
            ...
            <button id="submit" type="button" class="btn btn-primary">进入兴趣推荐</button>
